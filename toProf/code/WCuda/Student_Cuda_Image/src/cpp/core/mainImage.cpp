...
int mainImage(Settings& settings)
    ...
    Viewer<RayTracingGMProvider> vague(nozoomable, 25, 25); // imageOption px py
    //Viewer<RayTracingCMProvider> vague(nozoomable, 25, 25); // imageOption px py
    //Viewer<RayTracingSMProvider> vague(nozoomable, 25, 25); // imageOption px py
